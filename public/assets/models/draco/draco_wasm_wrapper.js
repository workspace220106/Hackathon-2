...
$jscomp.makeIterator = function (k) {
	const n = 'undefined' !== typeof Symbol && Symbol.iterator && k[Symbol.iterator];
...
const $jscomp$lookupPolyfilledValue = function (k, n) {
	...
	$jscomp.TRUST_ES6_POLYFILLS && 'function' === typeof Object.assign
		...
		: function (k, n) {
				for (let l = 1; l < arguments.length; l++) {
					const p = arguments[l];
					if (p) for (const h in p) $jscomp.owns(p, h) && (k[h] = p[h]);
				}
				return k;
		  };
$jscomp.polyfill(
...
const DracoDecoderModule = (function () {
	let k = 'undefined' !== typeof document && document.currentScript ? document.currentScript.src : void 0;
